...
/**
 * Monochrome Google mark. The two quarters that carry the brand's lighter hues are
 * rendered at reduced opacity so the four-segment shape still reads in one colour.
 */
function GoogleIcon({ size = 24, className, ...props }: IconProps) {
	return (
		<svg
